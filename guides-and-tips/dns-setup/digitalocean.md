...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/digitalocean-recheck-dns-records.png" alt="Mailtrap Re-check DNS Records button" width="563"></div>
{% endstep %}
