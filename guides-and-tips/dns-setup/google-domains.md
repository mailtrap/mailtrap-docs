...
Return to Mailtrap. On the Domain Verification page, you'll see the DNS records you need to add to Google Domains. These are Domain Verification, DKIM, SPF, DMARC, and Domain Tracking. You'll need the values under Type, Name, and Value.
