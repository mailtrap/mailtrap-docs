...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/godaddy-locate-domain.png" alt="GoDaddy domain list with Manage button" width="375"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/godaddy-add-new-record.png" alt="GoDaddy DNS settings page with Add New Record button" width="563"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/godaddy-copy-dns-values.png" alt="Copying DNS record values from Mailtrap" width="563"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/godaddy-recheck-dns-records.png" alt="Mailtrap Re-check DNS Records button" width="563"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/godaddy-dns-verified.png" alt="Mailtrap showing all DNS records verified with green status indicators" width="563"></div>
{% endstep %}
{% endstepper %}
