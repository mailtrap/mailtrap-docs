...
{% content-ref url="transactional-emails.md" %}
[transactional-emails.md](transactional-emails.md)
{% endcontent-ref %}
...
{% content-ref url="contacts-management.md" %}
[contacts-management.md](contacts-management.md)
{% endcontent-ref %}
