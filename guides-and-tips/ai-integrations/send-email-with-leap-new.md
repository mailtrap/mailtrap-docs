...
- `MAILTRAP_API_TOKEN` – This is the [Mailtrap API token](https://app.gitbook.com/s/S3xyr7ba7aGO19rc8dSK/account-and-organization/api-tokens), which you can create at any time in your account dashboard.
