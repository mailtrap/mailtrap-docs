...
![Mailtrap SMTP integration settings showing credentials and C# code sample for sending emails using System.Net.Mail library](../.gitbook/assets/mailtrap-dotnet-smtp-integration.png)
...
![Mailtrap API integration showing code sample for sending emails via RESTful API using C# and HttpClient with API token authentication](../.gitbook/assets/mailtrap-dotnet-api-integration.png)
