...
![Mailtrap SMTP integration interface showing C# code sample with SMTP credentials and MailKit library implementation](../.gitbook/assets/mailtrap-csharp-smtp-integration.png)
...
![Mailtrap API integration interface showing C# RESTful API code sample with HTTP client implementation](../.gitbook/assets/mailtrap-csharp-api-integration.png)
