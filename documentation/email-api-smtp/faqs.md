...
4. Navigate to the [**Sending Setup**](https://mailtrap.io/api-smtp/sending-setup) page and integrate Mailtrap with your application via API, SMTP, or your AI agent.
