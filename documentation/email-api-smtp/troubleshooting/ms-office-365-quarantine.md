...
description: How to resolve Mailtrap emails being sent to Office 365 quarantine
icon: shield-halved
---

# MS Office 365 Quarantine
...
* [Getting Started with Email API/SMTP](../sending-domain-setup.md)
