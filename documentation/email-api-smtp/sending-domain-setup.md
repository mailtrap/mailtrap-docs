...
<table data-view="cards"><thead><tr><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td>AWS Route 53</td><td><a href="https://app.gitbook.com/s/gkNigAKiqQtQub1GOdjY/dns-setup/aws-route-53">AWS Route 53</a></td></tr><tr><td>Cloudflare</td><td><a href="https://app.gitbook.com/s/gkNigAKiqQtQub1GOdjY/dns-setup/cloudflare">Cloudflare</a></td></tr><tr><td>Digital Ocean</td><td><a href="https://app.gitbook.com/s/gkNigAKiqQtQub1GOdjY/dns-setup/digitalocean">DigitalOcean</a></td></tr><tr><td>GoDaddy</td><td><a href="https://app.gitbook.com/s/gkNigAKiqQtQub1GOdjY/dns-setup/godaddy">GoDaddy</a></td></tr><tr><td>Google Cloud DNS</td><td><a href="https://app.gitbook.com/s/gkNigAKiqQtQub1GOdjY/dns-setup/google-cloud-dns">Google Cloud DNS</a></td></tr><tr><td>Google Domains</td><td><a href="https://app.gitbook.com/s/gkNigAKiqQtQub1GOdjY/dns-setup/google-domains">Google Domains</a></td></tr><tr><td>Namecheap</td><td><a href="https://app.gitbook.com/s/gkNigAKiqQtQub1GOdjY/dns-setup/namecheap">Namecheap</a></td></tr></tbody></table>
...
<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/sending-domains-compliance-pending.png" alt="Compliance check pending status with Fill In Compliance Form button" width="375"><figcaption><p>Compliance check pending status</p></figcaption></figure></div>
...
<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/godaddy-domain-list.png" alt="GoDaddy domain list showing mailtrap.club domain" width="375"><figcaption></figcaption></figure></div>
{% endstep %}

{% step %}
Open the DNS settings and click Add New Record.

<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/godaddy-add-new-record.png" alt="GoDaddy DNS Management with Add New Record button" width="563"><figcaption></figcaption></figure></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/sending-domains-copy-button.png" alt="" width="563"></div>
{% endstep %}

{% step %}
Paste them into your domain provider.

<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/godaddy-dns-new-record-form.png" alt="GoDaddy DNS new record form with CNAME type, name, and value fields" width="375"><figcaption></figcaption></figure></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/godaddy-dns-all-records-added.png" alt="GoDaddy DNS records table showing all Mailtrap DNS records added" width="563"><figcaption></figcaption></figure></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/sending-domains-dns-records-to-add.png" alt="Domain verification page showing DNS records with Missing status and Re-check DNS Records button" width="563"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/sending-domains-godaddy-all-records-added.png" alt="Example unsubscribe footer in email with unsubscribe link and company address" width="375"></div>
...
<div align="left" data-full-width="true" data-with-frame="true"><img src="../.gitbook/assets/sending-domains-verification-complete.png" alt="Unsubscribe Settings showing toggles for Bulk and Transactional emails"></div>
...
<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/sending-domains-verified-list.png" alt="Sending Domains list showing verified domains with status and emails sent" width="563"><figcaption><p>Sending Domains list with verified domains</p></figcaption></figure></div>

Remember that the domain with the Demo badge can be used to send emails only to the email address you registered with.

<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/sending-domains-demo-restrictions.png" alt="Demo domain showing restriction message that it can only send to yourself" width="375"><figcaption><p>Demo domain restrictions</p></figcaption></figure></div>
...
<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/sending-domains-pending-verified-statuses.png" alt="Sending Domains showing pending and verified status badges" width="375"><figcaption><p>Domain status badges - Pending and Verified</p></figcaption></figure></div>
...
<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/sending-domains-delete-button.png" alt="Sending Domains with delete button highlighted" width="563"><figcaption><p>Delete domain button</p></figcaption></figure></div>
...
<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/sending-domains-deleted-in-stats.png" alt="Stats overview showing deleted domains with (deleted) suffix" width="375"><figcaption><p>Deleted domains shown in stats</p></figcaption></figure></div>
