...
While using our services, Mailtrap may get alerts from these FBLs if your recipients submit spam complaints. You’ll see them in your [Stats](statistics/stats-dashboard.md) and may receive them via [Webhooks](https://help.mailtrap.io/article/102-webhooks).
