...
The tokens under **User settings** work only with Mailtrap Email API v1 and will be deprecated in the future. [Click here](../account-and-organization/api-tokens.md) to learn more about Email API tokens v2 and how to manage them.
...
<div align="left"><img src="../.gitbook/assets/user-profile-my-profile-dropdown.png" alt="User menu dropdown with My Profile option highlighted" width="375"></div>
...
<div align="left"><img src="../.gitbook/assets/user-profile-delete-button.png" alt="User Profile page with Delete My Profile button highlighted at the bottom" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/user-profile-create-account.png" alt="Mailtrap welcome page with Create Account button when no accounts exist" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/user-profile-leave-account.png" alt="Account Settings page with Leave Account option in the menu" width="563"></div>
