...
<div align="left"><img src="../.gitbook/assets/sandbox-load-testing-email-address-customization.png" alt="Email address customization interface showing alias and hash components for load testing" width="563"></div>
