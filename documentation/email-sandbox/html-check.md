...
<div align="left"><img src="../.gitbook/assets/sandbox-html-check-report.png" alt="HTML Check tab displaying market support score and problematic HTML elements" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/sandbox-html-check-filtering-options.png" alt="Filtering interface showing email client and device type selection options" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/sandbox-html-check-email-client-support.png" alt="Email client family support showing color-coded percentages for full, partial, and no support" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/sandbox-html-check-element-errors.png" alt="List of problematic HTML elements with line numbers and client support issues" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/sandbox-html-check-element-details.png" alt="Expanded element details showing specific client version compatibility information" width="563"></div>

Clicking on the line number will take you to the **HTML Source** tab where you can view your email's entire HTML.

<div align="left"><img src="../.gitbook/assets/sandbox-html-check-source-view.png" alt="HTML Source tab displaying full email HTML code with highlighted problematic lines" width="563"></div>
