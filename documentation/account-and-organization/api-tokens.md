...
![API Tokens settings page showing list of tokens with Name, Created By, Access, and Token columns](../privacy-and-security/.gitbook/assets/api-tokens-settings-page.png)

To add a new token, click the Add Token button in the upper right corner.

![API Tokens page with arrow pointing to the Add Token button in upper right corner](../privacy-and-security/.gitbook/assets/api-tokens-add-token-button.png)
...
![Token permissions editor showing different access levels for Account, Billing, Email Sending, and other resources](../privacy-and-security/.gitbook/assets/api-tokens-permissions-editor.png)
...
![API integration credentials showing Transactional and Bulk Stream options with Host and API Token fields](../privacy-and-security/.gitbook/assets/api-integration-credentials-streams.png)
...
![SMTP integration credentials showing Transactional and Bulk Stream options with Host, Port, Username, and Password fields](../privacy-and-security/.gitbook/assets/smtp-integration-credentials-streams.png)
...
![Token context menu with Edit permissions option highlighted](../privacy-and-security/.gitbook/assets/api-tokens-edit-permissions-menu.png)
...
<img src="../privacy-and-security/.gitbook/assets/api-tokens-account-admin-access.png" alt="Sandbox token permissions showing Account Admin access checkbox selected" data-size="original">
...
![Integration credentials page with Reset Credentials button highlighted](../privacy-and-security/.gitbook/assets/api-tokens-reset-credentials-button.png)

Then, click Reset Credentials and confirm your choice with the Yes, Reset button.

![Reset credentials confirmation dialog asking Are you sure you want to reset credentials with Yes Reset button](../privacy-and-security/.gitbook/assets/api-tokens-reset-credentials-dialog.png)
...
![API Tokens page with three-dot menu showing Reset API Token option](../privacy-and-security/.gitbook/assets/api-tokens-reset-menu-option.png)

Confirm your choice by clicking on the corresponding button.

![Confirmation dialog asking Are you sure you want to reset this API Token with Confirm button](../privacy-and-security/.gitbook/assets/api-tokens-reset-confirmation.png)
...
![API Tokens page with three-dot menu showing Edit permissions option highlighted](../privacy-and-security/.gitbook/assets/api-tokens-edit-permissions-option.png)
...
![API Tokens page with three-dot menu showing Delete token option highlighted](../privacy-and-security/.gitbook/assets/api-tokens-delete-menu-option.png)

Confirm the action by clicking the Confirm button.

![Confirmation dialog asking Are you sure you want to remove this Api Token with Confirm button](../privacy-and-security/.gitbook/assets/api-tokens-delete-confirmation.png)
