...
![API Tokens settings page showing list of tokens with Name, Created By, Access, and Token columns](../.gitbook/assets/api-tokens-add-token.png)

To add a new token, click the Add Token button in the upper right corner.

![API Tokens page with arrow pointing to the Add Token button in upper right corner](../.gitbook/assets/api-tokens-add-token.png)
