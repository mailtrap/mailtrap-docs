...
{% expand title="Cannot create list?" %}
**Check these items:**
- List name is unique
...
{% expand title="Contacts not showing in list?" %}
**Possible causes:**
...
{% expand title="List actions not working?" %}
**Try these solutions:**
- Refresh the page
- Clear browser cache
- Check permissions
- Verify list isn't locked
- Contact support if persists
{% endexpand %}

## Compliance and Lists

### GDPR Considerations

{% hint style="warning" %}
**Data Protection Requirements**
- Document consent for each list
- Provide easy unsubscribe options
- Honor deletion requests promptly
- Export list data when requested
- Maintain audit trail of list changes
{% endhint %}
...
- Update list descriptions
{% endtab %}

{% tab title="Quarterly" %}
- Audit list purposes
- Merge redundant lists
- Clean inactive contacts
- Document list strategies
{% endtab %}
{% endtabs %}
...
<tbody>
<tr>
<td><strong>Create Segments</strong><br>Build dynamic contact groups</td>
<td><a href="segments.md">Build Segments →</a></td>
</tr>
<tr>
<td><strong>Import Contacts</strong><br>Add contacts to your lists</td>
<td><a href="uploading-contacts.md">Upload Now →</a></td>
</tr>
<tr>
<td><strong>Launch Campaign</strong><br>Send to your lists</td>
