...
<div align="left"><img src="../.gitbook/assets/marketing-templates-overview.png" alt="Email Templates overview showing template management interface" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-menu.png" alt="Templates menu in the left navigation" width="563"></div>

2. Click the Create New Template button.

<div align="left"><img src="../.gitbook/assets/marketing-templates-create-button.png" alt="Create New Template button" width="563"></div>

3. Click the drop-down menu to select one of your domains, enter the Template name, Subject, and Category, and click Continue.

<div align="left"><img src="../.gitbook/assets/marketing-templates-create-form.png" alt="Form to create new template with domain, name, subject, and category fields" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-editor-choice.png" alt="Editor selection showing Drag and Drop and HTML editor options" width="563"></div>

5. Create/modify the design and click Finish.

<div align="left"><img src="../.gitbook/assets/marketing-templates-finish.png" alt="Template editor with Finish button" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-list.png" alt="List of all saved email templates" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-details.png" alt="Template details page showing name, subject, category, and domain fields" width="563"></div>

#### Drag & Drop Editor

The drag-and-drop editor allows you to design templates without any coding.

<div align="left"><img src="../.gitbook/assets/marketing-templates-drag-drop.png" alt="Drag and drop template editor interface" width="563"></div>

#### Code Editor

Code Editor allows you to edit the HTML or Text content, depending on the emails you want to send.

<div align="left"><img src="../.gitbook/assets/marketing-templates-code-editor.png" alt="Code editor interface for HTML and text content" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-error.png" alt="Template error message showing highlighted error in code editor" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-upload-image.png" alt="Upload image button in code editor" width="375"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-upload-new.png" alt="Upload New button to select image from local drive" width="375"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-upload-success.png" alt="Success notification after image upload" width="375"></div>

4\. Click the Copy URL button to copy the image URL to your clipboard, then click Template to return to the editing menu.

<div align="left"><img src="../.gitbook/assets/marketing-templates-copy-url.png" alt="Copy URL button to copy image URL to clipboard" width="375"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-add-image.png" alt="Template preview showing added image" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-test-data.png" alt="Test Data tab showing template variables" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-send-test.png" alt="Send Test button to send test email" width="375"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-integration-menu.png" alt="Templates menu in left navigation" width="563"></div>

2. Click the template you want to call using the API.

<div align="left"><img src="../.gitbook/assets/marketing-templates-select.png" alt="Select template from list for API integration" width="563"></div>

3. Open the Integration tab.

<div align="left"><img src="../.gitbook/assets/marketing-templates-integration-tab.png" alt="Integration tab in template details" width="563"></div>

4. With Email API/SMTP toggled on, click Integrate under Transactional Stream or Bulk Stream.

<div align="left"><img src="../.gitbook/assets/marketing-templates-api-integrate.png" alt="Email API/SMTP toggle with Integrate buttons for streams" width="563"></div>

5. Copy the necessary credentials such as Host, API Token, and Template UUID.

<div align="left"><img src="../.gitbook/assets/marketing-templates-transactional.png" alt="Transactional Stream API credentials" width="563"></div>

<div align="left"><img src="../.gitbook/assets/marketing-templates-bulk.png" alt="Bulk Stream API credentials" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-testing-menu.png" alt="Templates menu in left navigation" width="563"></div>

2. Click the template you want to call using the API.

<div align="left"><img src="../.gitbook/assets/marketing-templates-testing-select.png" alt="Select template from list for testing" width="563"></div>

3. Open the Integration tab.

<div align="left"><img src="../.gitbook/assets/marketing-templates-testing-tab.png" alt="Integration tab for template testing" width="563"></div>

4. Toggle the switch to Email Testing.

<div align="left"><img src="../.gitbook/assets/marketing-templates-testing-toggle.png" alt="Toggle switch to Email Testing mode" width="563"></div>

5. And click Integrate.

<div align="left"><img src="../.gitbook/assets/marketing-templates-testing-integrate.png" alt="Integrate button for Email Testing" width="375"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-testing-credentials.png" alt="Sandbox credentials for template testing" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-sandbox-result.png" alt="Email Testing sandbox showing received template test" width="563"></div>

* The Tech Info tab contains the link to the template you tested and lists all the variables used in the template.

<div align="left"><img src="../.gitbook/assets/marketing-templates-tech-info.png" alt="Tech Info tab showing template link and variables" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/marketing-templates-all-list.png" alt="Complete list of all accessible templates" width="563"></div>
