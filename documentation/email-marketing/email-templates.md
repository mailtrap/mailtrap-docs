...
<div align="left"><img src="../.gitbook/assets/template-list-view.png" alt="Email Templates overview showing template management interface" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/template-menu-nav.png" alt="Templates menu in the left navigation" width="563"></div>
{% endstep %}

{% step %}
**Click the Create New Template button**

<div align="left"><img src="../.gitbook/assets/template-list-create-button.png" alt="Create New Template button" width="563"></div>
{% endstep %}
...
<div align="left"><img src="../.gitbook/assets/template-details-form.png" alt="Form to create new template with domain, name, subject, and category fields" width="563"></div>
{% endstep %}
...
<div align="left"><img src="../.gitbook/assets/template-design-selection.png" alt="Editor selection showing Drag and Drop and HTML editor options" width="563"></div>
{% endstep %}
...
<div align="left"><img src="../.gitbook/assets/template-drag-drop-editor.png" alt="Template editor with Finish button" width="563"></div>
{% endstep %}
{% endstepper %}
...
<img src="../.gitbook/assets/template-final-list.png" alt="List of all saved email templates" data-size="original">
{% endhint %}
...
<div align="left"><img src="../.gitbook/assets/template-details-view.png" alt="Template details page showing name, subject, category, and domain fields" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/template-drag-drop-interface.png" alt="Drag and drop template editor interface" width="563"></div>
{% endtab %}

{% tab title="Code Editor" %}
Code Editor allows you to edit the HTML or Text content, depending on the emails you want to send.

<div align="left"><img src="../.gitbook/assets/template-html-code-editor.png" alt="Code editor interface for HTML and text content" width="563"></div>
...
<img src="../.gitbook/assets/marketing-templates-error.png" alt="Template error message showing highlighted error in code editor" data-size="original">
...
<div align="left"><img src="../.gitbook/assets/template-upload-image-button.png" alt="Upload image button in code editor" width="375"></div>
{% endstep %}
...
<div align="left"><img src="../.gitbook/assets/template-images-library.png" alt="Upload New button to select image from local drive" width="375"></div>
{% endstep %}
...
<div align="left"><img src="../.gitbook/assets/template-image-upload-success.png" alt="Success notification after image upload" width="375"></div>
{% endstep %}
...
<div align="left"><img src="../.gitbook/assets/template-copy-url-button.png" alt="Copy URL button to copy image URL to clipboard" width="375"></div>
{% endstep %}
...
<div align="left"><img src="../.gitbook/assets/template-image-in-code.png" alt="Template preview showing added image" width="563"></div>
{% endstep %}
{% endstepper %}
...
<div align="left"><img src="../.gitbook/assets/template-test-data-variables.png" alt="Test Data tab showing template variables" width="563"></div>
...
<div align="left"><img src="../.gitbook/assets/template-send-test-button.png" alt="Send Test button to send test email" width="375"></div>
