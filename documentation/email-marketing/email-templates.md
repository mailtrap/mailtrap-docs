...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-list-view.png" alt="Email Templates overview showing template management interface" width="563"></div>
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-menu-nav.png" alt="Templates menu in the left navigation" width="375"></div>
{% endstep %}

{% step %}
**Click the Create New Template button**

<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-list-create-button.png" alt="Create New Template button" width="563"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-design-selection.png" alt="Editor selection showing Drag and Drop and HTML editor options" width="375"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-drag-drop-editor.png" alt="Template editor with Finish button" width="563"></div>
{% endstep %}
{% endstepper %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-details-view.png" alt="Template details page showing name, subject, category, and domain fields" width="563"></div>
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-drag-drop-interface.png" alt="Drag and drop template editor interface" width="563"></div>
{% endtab %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-upload-image-button.png" alt="Upload image button in code editor" width="375"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-image-upload-success.png" alt="Success notification after image upload" width="563"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-copy-url-button.png" alt="Copy URL button to copy image URL to clipboard" width="563"></div>
{% endstep %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-image-in-code.png" alt="Template preview showing added image" width="375"></div>
{% endstep %}
{% endstepper %}
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-test-data-variables.png" alt="Test Data tab showing template variables" width="563"></div>
...
<div align="left" data-with-frame="true"><img src="../.gitbook/assets/template-send-test-button.png" alt="Send Test button to send test email" width="563"></div>
