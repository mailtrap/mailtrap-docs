...
#### Domain not verified
**Problem**: Can't send campaigns without verified domain
**Solution**:
...
#### Template not saving
**Problem**: Changes to email template lost
**Solution**:
...
**Problem**: Images broken in preview/sent emails
**Solution**:
...
### Advanced Topics
- [Segmentation Strategies](../audience/README.md)
- [Automation Workflows](../automations.md)
- [Analytics Deep Dive](../analytics/README.md)
