...
* [Tools](for-ai-agents/tools/README.md)
  * [MCP Server](for-ai-agents/tools/mcp-server.md)
  * [CLI app](for-ai-agents/tools/mailtrap-cli-app.md "Mailtrap email CLI")
  * [Skills](for-ai-agents/tools/skills.md)
  * [Prompts](for-ai-agents/tools/prompts.md)
  * [AI inbox](for-ai-agents/tools/ai-inbox.md)

## Email API/SMTP

* [Overview](email-api-smtp/overview.md)
* [Setup & Configuration](email-api-smtp/setup/README.md)
  * [Domain Setup](email-api-smtp/setup/sending-domain.md)
    ...
    * [GoDaddy](email-api-smtp/setup/sending-domain/godaddy.md)
...
* [Analytics & Reports](email-api-smtp/analytics/README.md)
  ...
  * [Mailbox Providers](email-api-smtp/analytics/mailbox-providers.md)
  * [Statuses and Events](email-api-smtp/analytics/statuses-and-events.md)
...
* [Advanced Features](email-api-smtp/advanced/README.md)
  ...
  * [Unsubscribe settings - Footers & Links](email-api-smtp/advanced/unsubscribe-settings-footers-and-links.md)
  * [Tracking settings - Opens and Clicks tracking](email-api-smtp/advanced/tracking-settings-opens-and-clicks-tracking.md)
...
* [Testing Features](email-sandbox/testing/README.md)
  ...
  * [Device Previews](email-sandbox/testing/device-previews.md)
...
* [Contacts Management](email-marketing/contacts/README.md)
  ...
  * [Custom Fields](email-marketing/contacts/custom-fields.md)
...
* [User Management & Organizations](account-and-organization/management/README.md)
  ...
  * [SSO Guide](account-and-organization/management/sso/README.md)
    * [Azure (Microsoft Entra)](account-and-organization/management/sso/azure-microsoft-entra.md)
    * [Okta](account-and-organization/management/sso/okta.md)
