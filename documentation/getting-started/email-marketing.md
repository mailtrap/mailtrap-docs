...
<figure><img src="../.gitbook/assets/marketing-campaign-create-button (1).png" alt="Email Marketing page with Create New Campaign button" width="563"><figcaption><p>Create New Campaign button</p></figcaption></figure>
{% endstep %}
...
<figure><img src="../.gitbook/assets/marketing-campaign-company-details (1).png" alt="Company details form for campaign compliance" width="563"><figcaption><p>Company details form</p></figcaption></figure>
{% endstep %}
...
<figure><img src="../.gitbook/assets/marketing-campaign-settings (1).png" alt="Campaign details form with domain, name, subject, and email settings" width="563"><figcaption><p>Campaign details form</p></figcaption></figure>
{% endstep %}
...
<figure><img src="../.gitbook/assets/marketing-campaign-design-editor (1).png" alt="Template selection page with Drag &#x26; Drop and HTML editors" width="563"><figcaption><p>Template selection page</p></figcaption></figure>
{% endstep %}

{% step %}
Create your campaign design, click Save, and then Continue.

<figure><img src="../.gitbook/assets/getting-started-drag-drop-editor (1).png" alt="Drag and drop email editor interface" width="563"><figcaption><p>Drag and drop email editor</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/getting-started-audience-selection (1).png" alt="Audience selection with including and excluding lists" width="563"><figcaption><p>Audience selection</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/marketing-campaign-send-options (1).png" alt="Send and schedule campaign options" width="563"><figcaption><p>Send and schedule options</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/marketing-campaign-schedule (1).png" alt="Schedule campaign form with date and time picker" width="563"><figcaption><p>Schedule campaign form</p></figcaption></figure>
{% endstep %}
{% endstepper %}
