...
<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-type="content-ref"></th></tr></thead><tbody><tr><td><i class="fa-mcp">:mcp:</i> <strong>MCP</strong></td><td><em>Official Mailtrap MCP server</em></td><td><a href="https://app.gitbook.com/s/gkNigAKiqQtQub1GOdjY/ai-powered-integrations/mcp-server">Mailtrap MCP Server</a></td></tr><tr><td><i class="fa-rectangle-terminal">:rectangle-terminal:</i> <strong>CLI</strong></td><td><em>Official command-line interface for Mailtrap</em></td><td><a href="email-api-smtp/advanced/mailtrap-cli-app.md">mailtrap-cli-app.md</a></td></tr></tbody></table>
